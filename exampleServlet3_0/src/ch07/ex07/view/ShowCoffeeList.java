...
public class ShowCoffeeList extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<HTML><HEAD><TITLE>Coffee Catalog</TITLE>");
		...
		out.println("    <H3>咖啡目錄(Servlet 3.0)</H3>");
		out.println("  </TD>");
		out.println("</TR>");
		...
		out.println("<BR><BR><HR><BR><CENTER><small>&lt;&lt;<a href='_ch07.jsp'>回前頁</a>&gt;&gt;</small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
