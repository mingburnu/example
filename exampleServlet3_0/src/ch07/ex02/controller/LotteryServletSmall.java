...
@WebServlet(
	name="Lottery2",
	urlPatterns={"/ch07/SmallLottery.do"},
	initParams={
			@WebInitParam(name="maxNumber", value="39"),
			@WebInitParam(name="amountOfBalls", value="5"),
	}
)
public class LotteryServletSmall extends HttpServlet {
