...
<table border="1">
  <tr height="80" bgcolor="lightblue" align="center">
    <td  width="350"><p align="left"/>
      <a href="ex01/ch04_01.jsp">MVC實作</a><BR><font face="verdana" size="-2">WebContent/ch04/ex01/ch04_01.jsp<BR>WebContent/ch04/ex01/*.jsp<BR>ch04.ex01.controller.*.java<BR>ch04.ex01.model.*.java</font></td>
    <td  width="350"><p align="left"/>
  ...
  <tr height="80" bgcolor="lightblue" align="center">
    <td  width="350"><p align="left">
      <a href="ex03/ch04_ex03_mvc.jsp">新增會員資料(SQLServer)</a><BR><font face="verdana" size="-2">WebContent/ch04/ex03/ch04_ex03_mvc_V4.jsp<BR>WebContent/ch04/ex03/*.jsp<BR>ch04.ex03.controller.*.java<BR>ch04.ex03.model.*.java</font></td>
    <td  width="350"><p align="left">
