...
public class EDMTableDataWithImageReset {
   ...
   public static void main(String args[]) {
      ...
      String dbURL = "jdbc:sqlserver://" + GlobalService.host + ":1433;databaseName=JSPDB" ;      
      Connection con;
      ...
      String sql1  = "";
      try {
          // 載入實作java.sql.Driver介面的類別
          Class.forName(driverName);
          // 連上後端的資料庫
          con =  DriverManager.getConnection(dbURL,"sa", "sa123456");
          ...
          System.err.print("驅動程式類別找不到: " + e.getMessage());
          e.printStackTrace() ;
          return ;
      ...
      try {
          ...
          sql1 = "insert into eMember " +
	  		...
	  		" experience, register, total_amt, memberImage, fileName) " +
	  		" values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
          pstmt1 = con.prepareStatement(sql1);
          pstmt1.setString(1, "kitty");
          pstmt1.setString(2, "張君雅");
          pstmt1.setString(3, GlobalService.getMD5Endocing("123"));  //密碼都是 123
          ...
          // 讀取圖片檔
    	  File aFile = new File("WebContent/images/smallPic/kittyabcde12345678901234567890.jpg");
		...
		int r = pstmt1.executeUpdate();
          ...
          pstmt1.setString(3, GlobalService.getMD5Endocing("123"));
          ...
          pstmt1.setDouble(10, 0.0);
          // 讀取圖片檔
    	  aFile = new File("WebContent/images/smallPic/snoopy.jpg");
    	  size = aFile.length();
          ...
          pstmt1.setDouble(10, 0.0);
          // 讀取圖片檔
    	  aFile = new File("WebContent/images/smallPic/mickyabcde12345678901234567890.jpeg");
    	  size = aFile.length();
    	  is = new FileInputStream(aFile);
    	  // 設定Image欄位
    	  pstmt1.setBlob(11, is, size);
