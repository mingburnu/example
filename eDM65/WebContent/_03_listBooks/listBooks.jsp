...
<!--   購物車的標題   -->          
   <TR>
      <TD colspan='4'> 
         <TABLE width="820" style="background:#FFE4C4">
            ...
            <TR height='2'><TD width="270"><A href="<c:url value='../_04_ShoppingCart/ShowCartContent.jsp' />" >購物清單</A></TD><TD width="280">&nbsp;</TD><TD width="270" align='right'><FONT  color='red' size='-1'>金額小計:<c:out value="${ShoppingCart.subtotal}" default="0"/> 元</FONT></TD></TR>          
         </TABLE>
      </TD>
   </TR>   
   <!-- 
      ...
      <TR bgColor="${rowColor}">
         <TD rowspan='3' width='64'> 
             <!-- 
              ...
              -->
             <img height='100' width='80' src='${pageContext.servletContext.contextPath}/_00_init/getImage?id=${aBookBean.bookID}&type=BOOK'>
         </TD>
         <TD height='18' width='560'>
             <TABLE border='1'>
                <TR>
                    <TD width='560'>
                                                            書名：${aBookBean.title}
   ...
   <TR height='18' bgColor="${rowColor}">
       <TD width='560'><TABLE border='1'><TR><TD width='420'>作者：${aBookBean.author}</TD><TD width='140'>出版社：${fn:substring(aBookBean.companyName,0,2)}</TD></TR></TABLE></TD>
   </TR>
   <TR bgColor="${rowColor}">
       <TD width='560'>
           <TABLE border='1'> 
