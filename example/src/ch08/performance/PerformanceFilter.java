...
public class PerformanceFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if ( target != null && target.equals("DM") &&  req.getServletPath().endsWith("DriverManagerServlet" )) {
        	...
        	System.out.println("Driver Manager 版，時間=" + (end - begin) + " 毫秒(ms)" + " , servletPath()=" + req.getServletPath());
        }
        if (  target != null &&  target.equals("DS")  &&  req.getServletPath().endsWith("DataSourceServlet" )) {
        	...
        	System.out.println("Data  Source   版，時間=" + (end - begin) + " 毫秒(ms) "  + " , servletPath()=" + req.getServletPath());
        }
	}
