...
<ul >
  ...
  <li><a href="/example/ch03/index.jsp" >三、JSP 網頁</a> </li>
  <!-- 
 ...
 -->  
  ...
  <li><a href="/example/ch05/_ch05.jsp" >五、EL、動作元素與JavaBean</a> </li>
  <li><a href="/example/ch06/_ch06.jsp" >六、Session 與 Cookie</a> </li>  
  <li><a href="/example/ch07/_ch07.jsp" >七、Servlet Servlet Context 生命週期</a> </li>
  <li><a href="/example/ch08/index.jsp" >八、Filter 過濾器</a> </li>
</ul>
<P/>
</div>
</body>
