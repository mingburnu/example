...
public class MemberDAO {
	...
	private static final String SELECT_BY_ID = "Select memberId, password, name, address, phone, birthday, registerdate, picture, weight from memberLab04_02 where memberId = ?";
	...
	private static final String SELECT_ALL = "Select memberId, password, name, address, phone, birthday,registerdate ,picture ,weight from memberLab04_02";
	...
	private static final String INSERT = "Insert into memberLab04_02 (memberId, password, name, address, phone, birthday, registerdate, picture, weight) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	private static final String DELETE = "Delete from memberLab04_02 where memberId=?";
