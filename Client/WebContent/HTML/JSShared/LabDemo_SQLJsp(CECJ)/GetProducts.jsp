...
String query = "select BookID,BookName,UnitPrice,BookImage from Products";
...
try{
	...
	stmt = conn.createStatement();	
	 ...
	 while (rs.next()) {
		 ...
		 m1.put("BookID",rs.getString(1));   
		 m1.put("BookName", rs.getString(2)); 
		 m1.put("UnitPrice",rs.getString(3)); 
		 m1.put("BookImage",rs.getString(4));
